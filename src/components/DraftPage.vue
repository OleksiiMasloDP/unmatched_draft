    ...
    <div class="top-wrap" :class="{ 'sticky-active': current }">
      <div
        ...
        :style="{
          ...
          boxShadow: '0 0 20px ' + turnColor + '44',
        }"
      >
        {{ currentTurnText }}
      </div>
      ...
      <div class="controls-row">
        ...
        <div class="custom-select-wrapper">
          <select v-model="currentFormat" @change="saveToStorage">
            <option
              v-for="(fData, fKey) in availableFormats"
              :key="fKey"
              :value="fKey"
            >
              {{ fData.name }}
      ...
      <div class="col-lg-3 order-player">
        ...
        <div class="slot-box">
          <template v-for="char in player.picks" :key="char.id">
            <div
              v-if="
                currentStep === 'characters' || !postBans.player.has(char.id)
              "
      ...
      <div class="col-lg-3 order-opponent">
        ...
        <div v-if="currentStep === 'characters'" class="slot-box mb-3 mb-md-4">
          <div
            ...
            :style="{ '--ban-color-rgb': '255, 79, 109' }"
          >
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button
            type="button"
            class="btn btn-dark fw-semibold btn-modal-cancel"
            @click="cancelReset"
          >
            {{ t("modalCancel") }}
          </button>
          <button
            type="button"
            class="btn btn-danger fw-bold btn-modal-confirm"
            @click="confirmReset"
          >
            {{ t("modalConfirm") }}
          </button>
